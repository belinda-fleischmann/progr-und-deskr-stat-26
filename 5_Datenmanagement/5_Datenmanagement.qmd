...
\footnotesize
```{r, eval = T, echo = F}
skriptpfad <- normalizePath(knitr::current_input())
r_skriptordner  <- dirname(skriptpfad)
print(r_skriptordner)
...
datenordner   <- file.path(dirname(work_dir), "Daten")       # Datenverzeichnispfad
...
write.table(                                                # .csv Schreibfunktion
    ...
    file = output_dateipfad,                                # Dateinname
